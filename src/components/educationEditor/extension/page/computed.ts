// @ts-noCheck
import { TABLE, CASSIE_BLOCK, CASSIE_BLOCK_EXTEND, EXTEND, HEADING, LISTITEM, PAGE, PARAGRAPH, TABLE_ROW, ORDEREDLIST, BULLETLIST } from "@/components/educationEditor/extension/nodeNames";
import { NodesComputed, PluginState, SplitParams } from "@/components/educationEditor/extension/page/types";
import { Fragment, Node, Slice } from "@tiptap/pm/model";
import { EditorState, Transaction } from "@tiptap/pm/state";
import { getAbsentHtmlH, getBreakPos, getContentSpacing, getDefault, getDomHeight, SplitInfo } from "@/components/educationEditor/extension/page/core";
import { getNodeType } from "@tiptap/core";
import { ReplaceStep } from "@tiptap/pm/transform";
import { Editor } from "@tiptap/core/dist/packages/core/src/Editor";
import { getId } from "@/components/educationEditor/utils/id";
