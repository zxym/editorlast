...
<script lang="ts">
import { CassieKit } from "@/components/educationEditor/extension/CassieKit";

import { EditorContent } from "@tiptap/vue-3";

import { onBeforeUnmount, onMounted, ref, shallowRef } from "vue";
import { UnitConversion } from "@/components/educationEditor/extension/page/core";

import { newContent, pageOldContent, headerlist, footerlist } from "@/components/educationEditor/plugins/content";
import { getSchema } from "@tiptap/core";
import { DOMSerializer, Node } from "@tiptap/pm/model";
import { recreateTransform } from "@/components/educationEditor/extension/track/recreate-steps";
import { ChangeSet } from "@/components/educationEditor/extension/track/changeset";
import applyDevTools from "prosemirror-dev-tools";
import { Editor } from "@tiptap/vue-3";
import { EditorState, Plugin, PluginKey } from "@tiptap/pm/state";
import { renderDecorations } from "@/components/educationEditor/extension/track/track-changes/renderDecorations";
