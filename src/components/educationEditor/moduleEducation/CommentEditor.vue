...
<script lang="ts">
import OuterCommentVue from "@/components/educationEditor/plugins/OuterComment.vue";
import { CassieKit, Comment } from "@/components/educationEditor/extension";
...
import { pageContentHtml, headerlist, footerlist } from "@/components/educationEditor/plugins/content";
...
import { DiffExtension } from "@/components/educationEditor/extension/track";

import FileTools from "@/components/educationEditor/tools/FileTools.vue";
